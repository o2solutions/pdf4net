...
namespace O2S.Components.PDF4NET.Samples
{
    class TaggedFlowDocument
    {
        static void Main(string[] args)
        {
            ...
            FileStream logoImageStream = new FileStream(supportPath + "logo.png", FileMode.Open, FileAccess.Read, FileShare.Read);
            FileStream verdanaFontStream = new FileStream(supportPath + "verdana.ttf", FileMode.Open, FileAccess.Read, FileShare.Read);
            FileStream verdanaBoldFontStream = new FileStream(supportPath + "verdanab.ttf", FileMode.Open, FileAccess.Read, FileShare.Read);
            ...
            logoImageStream.Dispose();
            verdanaFontStream.Dispose();
            verdanaBoldFontStream.Dispose();
            ...
            PDFUAFormatter.Save(document.GetFixedDocument(), "TaggedFlowDocument.pdf", PDFUAFormat.PDFUA1);
        ...
        {
            // Customize the tagging information for the logo image.
            // Create an explicit structure element for the image and set its properties.
            // This structure element will be placed as direct child of the cell's structure element.
            logoImage.StructureElement = new PDFStructureElement(PDFStandardStructureTypes.Figure);
            logoImage.StructureElement.ActualText = "O2 Solutions";
            logoImage.StructureElement.AlternateDescription = "Logo of O2 Solutions";

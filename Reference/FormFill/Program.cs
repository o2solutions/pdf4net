...
namespace O2S.Components.PDF4NET.Samples.NetCore
{
    class FormFill
    {
        static void Main(string[] args)
        {
            ...
            FileStream formStream = new FileStream(supportPath + "formfill.pdf", FileMode.Open, FileAccess.Read, FileShare.Read);
            SampleOutputInfo[] output = O2S.Components.PDF4NET.Samples.FormFill.Run(formStream);
            formStream.Dispose();

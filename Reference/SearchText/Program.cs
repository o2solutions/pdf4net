...
namespace O2S.Components.PDF4NET.Samples.NetCore
{
    class SearchText
    {
        static void Main(string[] args)
        {
            ...
            FileStream searchTextInput = new FileStream(supportPath + "content.pdf", FileMode.Open, FileAccess.Read, FileShare.Read);
            SampleOutputInfo[] output = O2S.Components.PDF4NET.Samples.SearchText.Run(searchTextInput);

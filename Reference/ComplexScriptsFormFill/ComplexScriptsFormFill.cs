...
{
    public class ComplexScriptsFormFill
    {
        static void Main(string[] args)
        {
            PDFFixedDocument document = new PDFFixedDocument();

            FormFillArabic(document);
            FormFillBengali(document);
            FormFillDevanagari(document);
            FormFillGujarati(document);
            FormFillGurmukhi(document);
            FormFillHebrew(document);
            FormFillKannada(document);
            FormFillKashmiri(document);
            FormFillKhmer(document);
            FormFillKurdishSorani(document);
            FormFillLao(document);
            FormFillMalayalam(document);
            FormFillMyanmarBurmese(document);
            FormFillOriya(document);
            FormFillPersian(document);
            FormFillSindhi(document);
            FormFillTamil(document);
            FormFillTelugu(document);
            FormFillThai(document);
            FormFillUrduNastaliq(document);
            FormFillUyghur(document);
            
            document.Save("ComplexScriptsFormFill.pdf");

            Console.WriteLine("File saved with success to current folder.");
        }
        
        public static void FormFillArabic(PDFFixedDocument document)
        {
            ...
            page.Canvas.DrawString("Arabic", arialFont, blackBrush, 30, 30);
    ...
    "المادة 2\r\nلكل إنسان حق التمتع بكافة الحقوق والحريات الواردة في هذا الإعلان، دون أي تمييز، كالتمييز بسبب العنصر أو اللون أو الجنس أو اللغة أو الدين أو الرأي السياسي أو أي رأي آخر، أو الأصل الوطني أو الإجتماعي أو الثروة أو الميلاد أو أي وضع آخر، دون أية تفرقة بين الرجال والنساء. وفضلاً عما تقدم فلن يكون هناك أي تمييز أساسه الوضع السياسي أو القانوني أو الدولي لبلد أو البقعة التي ينتمي إليها الفرد سواء كان هذا البلد أو تلك البقعة مستقلاً أو تحت الوصاية أو غير متمتع بالحكم الذاتي أو كانت سيادته خاضعة لأي قيد من القيود.";
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentArabic");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = arialFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        }

        public static void FormFillBengali(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Bengali", bengaliFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentBengali");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = bengaliFont;
            contentTextBox.Widgets[0].AppearanceFont = bengaliFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillDevanagari(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Devanagari", devanagariFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentDevanagari");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = devanagariFont;
            contentTextBox.Widgets[0].AppearanceFont = devanagariFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillGujarati(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Gujarati", gujaratiFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentGujarati");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = gujaratiFont;
            contentTextBox.Widgets[0].AppearanceFont = gujaratiFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillGurmukhi(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Gurmukhi", gurmukhiFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentGurmukhi");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = gurmukhiFont;
            contentTextBox.Widgets[0].AppearanceFont = gurmukhiFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillHebrew(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Hebrew", hebrewFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentHebrew");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = hebrewFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;
        ...
        public static void FormFillKannada(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Kannada", kannadaFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentKannada");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = kannadaFont;
            contentTextBox.Widgets[0].AppearanceFont = kannadaFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillKashmiri(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Kashmiri", kashmiriFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentKashmiri");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = kashmiriFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;
        ...
        public static void FormFillKhmer(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Khmer", khmerFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentKhmer");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = khmerFont;
            contentTextBox.Widgets[0].AppearanceFont = khmerFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillKurdishSorani(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("KurdishSorani", kurdishSoraniFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentKurdish");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = kurdishSoraniFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;
        ...
        public static void FormFillLao(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Lao", laoFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentLao");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = laoFont;
            contentTextBox.Widgets[0].AppearanceFont = laoFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillMalayalam(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Malayalam", malayalamFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentMalayalam");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = malayalamFont;
            contentTextBox.Widgets[0].AppearanceFont = malayalamFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillMyanmarBurmese(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Myanmar Burmese", myanmarBurmeseFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentMyanmarBurmese");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = myanmarBurmeseFont;
            contentTextBox.Widgets[0].AppearanceFont = myanmarBurmeseFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillOriya(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Oriya", oriyaFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentOriya");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = oriyaFont;
            contentTextBox.Widgets[0].AppearanceFont = oriyaFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillPersian(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Persian", persianFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentPersian");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = persianFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;
        ...
        public static void FormFillSindhi(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Sindhi", sindhiFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentSindhi");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = sindhiFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;
        ...
        public static void FormFillTamil(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Tamil", tamilFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentTamil");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = tamilFont;
            contentTextBox.Widgets[0].AppearanceFont = tamilFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillTelugu(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Telugu", teluguFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentTelugu");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = teluguFont;
            contentTextBox.Widgets[0].AppearanceFont = teluguFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillThai(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Thai", thaiFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentThai");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = thaiFont;
            contentTextBox.Widgets[0].AppearanceFont = thaiFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            contentTextBox.Multiline = true;
            contentTextBox.Text = text;
        ...
        public static void FormFillUrduNastaliq(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Urdu Nastaliq", urduNastaliqFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentUrdu");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = urduNastaliqFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;
        ...
        public static void FormFillUyghur(PDFFixedDocument document)
        {
            PDFPage page = document.Pages.Add();
            ...
            page.Canvas.DrawString("Uyghur", uyghurFont, blackBrush, 30, 30);
            ...
            PDFTextBoxField contentTextBox = new PDFTextBoxField("contentUyghur");
            page.Fields.Add(contentTextBox);
            contentTextBox.Widgets[0].DisplayRectangle = new PDFDisplayRectangle(30, 60, 550, 400);
            contentTextBox.Widgets[0].Font = new PDFStandardFont(PDFStandardFontFace.Helvetica, 12);
            contentTextBox.Widgets[0].AppearanceFont = uyghurFont;
            contentTextBox.Widgets[0].BorderColor = PDFRgbColor.Black;
            contentTextBox.Widgets[0].BorderWidth = 1;
            (contentTextBox.Widgets[0] as PDFTextBoxWidget).Align = PDFStringHorizontalAlign.Right;
            contentTextBox.TextDirection = PDFTextDirection.RightToLeft;

...
namespace O2S.Components.PDF4NET.Samples.NetCore
{
    class Encryption
    {
        static void Main(string[] args)
        {
            ...
            FileStream encryptionInput = new FileStream(supportPath + "encrypted.pdf", FileMode.Open, FileAccess.Read, FileShare.Read);
            SampleOutputInfo[] output = O2S.Components.PDF4NET.Samples.Encryption.Run(encryptionInput);
            encryptionInput.Dispose();

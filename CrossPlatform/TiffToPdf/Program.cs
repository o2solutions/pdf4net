...
namespace O2S.Components.PDF4NET.Samples.NetCore
{
    class TiffToPDF
    {
        static void Main(string[] args)
        {
            ...
            FileStream tiffStream = new FileStream(supportPath + "sample.tif", FileMode.Open, FileAccess.Read, FileShare.Read);
            SampleOutputInfo[] output = O2S.Components.PDF4NET.Samples.TiffToPDF.Run(tiffStream);
            tiffStream.Dispose();

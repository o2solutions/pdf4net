...
namespace O2S.Components.PDF4NET.Samples.NetCore
{
    class Watermarks
    {
        static void Main(string[] args)
        {
            ...
            FileStream watermarksInput = new FileStream(supportPath + "content.pdf", FileMode.Open, FileAccess.Read, FileShare.Read);
            SampleOutputInfo[] output = O2S.Components.PDF4NET.Samples.Watermarks.Run(watermarksInput);
            watermarksInput.Dispose();
